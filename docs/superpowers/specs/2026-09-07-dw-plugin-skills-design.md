...
Package B of the Part 4 packaging work from the agent-catalog-legibility
design (Channel B: model families, resolved 2026-09-07). It answers the open question of how model-specific knowledge reaches an
