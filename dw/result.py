    ...
    def save_artifact(
        ...
        try:
            if content_type.startswith("video"):
                ...
                # A track generated by a model carries the rate it was generated
                # at, which beats the default - but not a rate the workflow named
                sample_rate = self.result_definition.get(
                    "sample_rate",
                    self.result_definition.get(
                        "samplerate",
                        getattr(artifact, "sample_rate", None)
