...
def build_server(client):
    ...
    server = MCPServer(
        ...
        instructions=(
            ...
            "workflow's summary, shape, traits, cost (with `per_entry` "
            "for a list-driven one), variable names and, for a "
            "list-driven workflow, `lists` - what an entry of each list "
            "carries - "
