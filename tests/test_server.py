...
def test_gallery_lists_media_and_reads_metadata(server, tmp_path):
    ...
    with server(success_script) as client:
        ...
        # a plain image, a video stand-in, and a text deliverable (#238)
