        ...
        "steps": [
            {
                ...
                "task": {
                    "command": "qr_code",
                    "arguments": {
                        "qr_code_contents": "variable:content"
                    }
                },
                "result": {
...
class TestWorkflowExecution:
    ...
    def test_workflow_with_variable_override(self, simple_qr_workflow, temp_workflow_dir):
            ...
            "steps": [
                {
                    ...
                    "task": {
                        "command": "qr_code",
                        "arguments": {
                            "qr_code_contents": "variable:undefined_var"
                        }
                    },
                    "result": {
                        "content_type": "image/jpeg",
